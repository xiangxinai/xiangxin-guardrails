    ...
    <Card>
      <Space direction="vertical" size="large" style={{ width: '100%' }}>
        ...
        <div>
          ...
          <Alert
            message={t('account.apiKeysMoved') || 'API Keys and documentation have been moved'}
            description={
              <>
                {t('account.apiKeysMovedDesc') || 'Please go to Configuration Center > API Keys to manage your API keys and view API documentation.'}
                <Button type="link" onClick={() => window.location.href = '/platform/config/api-keys/'} style={{ paddingLeft: 8 }}>
                  {t('common.goToConfig') || 'Go to Config Center →'}
                </Button>
              </>
            }
            type="info"
